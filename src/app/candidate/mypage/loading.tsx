          ...
          <div className='w-full max-w-[880px] flex-1 box-border md:px-6 px-0'>
            ...
            <div className='bg-white rounded-[10px] p-6 shadow-sm mb-10'>
              <div className='space-y-3'>
                {[0, 1, 2].map(i => (
                  <div
                    key={i}
                    className='h-16 w-full bg-gray-50 rounded animate-pulse'
                  />
                ))}
              </div>
            </div>

            {/* おすすめ求人見出しのスケルトン（バナー部分） */}
            <div className='flex flex-row items-center gap-3 pb-2 border-b-2 border-[#DCDCDC] mb-4'>
              <div className='w-6 h-6 bg-gray-200 rounded animate-pulse' />
            ...
            <div className='flex flex-col gap-4'>
              {[0, 1, 2].map(i => (
                <div
                  key={i}
                  className='bg-white rounded-[10px] p-4 shadow-sm flex gap-4 items-start'
                >
