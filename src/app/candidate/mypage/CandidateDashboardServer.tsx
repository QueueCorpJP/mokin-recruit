  ...
  return (
    <div className='min-h-screen bg-gray-50'>
      ...
      <div className='max-w-6xl mx-auto px-4 py-8'>
        {/* タスクセクション */}
        <div className='mb-8'>
          <SectionHeading iconSrc='/icons/task.svg' iconAlt='タスク'>
            やることリスト
          </SectionHeading>
        ...
        {/* メッセージセクション */}
        <div className='mb-8'>
          <SectionHeading iconSrc='/icons/message.svg' iconAlt='メッセージ'>
            最新のメッセージ
          </SectionHeading>
            ...
            {messages.length === 0 ? (
              ...
              <MessageListCard
                messages={messages.slice(0, 5).map((message: any) => ({
                  ...
                  sender:
                    (message.rooms as any)?.company_groups?.company_account
                      ?.company_name || '企業名未設定',
        ...
        {/* おすすめ求人セクション */}
        <div className='mb-8'>
          <SectionHeading iconSrc='/icons/job.svg' iconAlt='求人'>
            おすすめ求人
          </SectionHeading>
              ...
              jobs
                ...
                .map((job: JobPosting) => (
                  <JobPostCard
                    ...
                    imageUrl={
                      (job.image_urls || [])[0] || '/images/default-job.png'
                    }
                    imageAlt={job.title}
                    starred={false}
                    apell={job.company_attractions || []}
                  />
                ))
            )}
          </div>
          <div className='mt-6 text-center'>
            <Link href='/candidate/search'>
              <Button variant='outline'>もっと求人を見る</Button>
            </Link>
          </div>
        </div>
        ...
        {/* FAQ セクション */}
        <div className='mb-8'>
          <SectionHeading iconSrc='/icons/faq.svg' iconAlt='FAQ'>
            よくある質問
          </SectionHeading>
          <div className='space-y-4'>
            <FaqBox
