...
export default function CompanyDetailsSidebar({
  ...
  // エラー発生時やデータが取得できない場合のフォールバック処理
  const displayData = companyData || {
    companyName: fallbackData?.companyName || '企業名未設定',
    companyLogo: '/company.jpg',
    representative: fallbackData?.representative || '代表者未設定',
    establishedYear: '未設定',
    capital: '未設定',
    employeeCount: '未設定',
    industry: fallbackData?.industry || '業種未設定',
    businessContent: fallbackData?.businessContent || '事業内容未設定',
    address: fallbackData?.address || '所在地未設定',
    companyPhase: '未設定',
    website: 'URL未設定',
  };

  // エラー時の表示
  if (companyDataError && !companyDataLoading) {
    return (
      <div className='w-full lg:w-[320px] bg-white rounded-[10px] p-6 max-w-full overflow-hidden'>
        <div className='flex flex-col gap-6 items-center justify-center h-32'>
          <div className='text-red-500 text-center'>
            <div className="font-['Noto_Sans_JP'] font-medium text-[14px]">
              企業情報の読み込みに失敗しました
            </div>
            {fallbackData?.companyName && (
              <div className="font-['Noto_Sans_JP'] font-bold text-[16px] mt-2 text-[#323232]">
                {fallbackData.companyName}
              </div>
            )}
          </div>
  ...
  return (
    <div className='w-full lg:w-[320px] bg-white rounded-[10px] p-6 max-w-full overflow-hidden'>
      <div className='flex flex-col gap-6 items-start justify-start max-w-full overflow-hidden'>
        <h2 className="font-['Noto_Sans_JP'] font-bold text-[18px] leading-[1.6] tracking-[1.8px] text-[#323232] break-words overflow-wrap-break-word line-break-auto max-w-full text-center">
          {companyDataLoading ? (
        ...
        <div className='flex flex-col gap-2 items-start justify-start w-full'>
          ...
          <div className='flex flex-row gap-2 items-start justify-start'>
            <span className="font-['Noto_Sans_JP'] font-medium text-[16px] leading-[2] tracking-[1.6px] text-[#323232] break-words overflow-wrap-break-word line-break-auto max-w-full">
              ...
              ) : displayData.establishedYear !== '未設定' ? (
                `${displayData.establishedYear}年`
              ) : (
                displayData.establishedYear
              )}
            </span>
          </div>
        </div>
        ...
        <div className='flex flex-col gap-2 items-start justify-start w-full'>
          ...
          <div className='flex flex-row gap-2 items-start justify-start'>
            <span className="font-['Noto_Sans_JP'] font-medium text-[16px] leading-[2] tracking-[1.6px] text-[#323232] break-words overflow-wrap-break-word line-break-auto max-w-full">
              ...
              ) : displayData.employeeCount !== '未設定' ? (
                `${displayData.employeeCount}人`
              ) : (
          ...
          <div className='min-w-0 max-w-full overflow-hidden'>
            <div className="font-['Noto_Sans_JP'] font-medium text-[16px] leading-[2] tracking-[1.6px] text-[#323232] break-words overflow-wrap-break-word line-break-auto">
              {companyDataLoading ? (
                ...
                (() => {
                  const industry = displayData.industry;
