...
function renderProfilePage(candidateProfile: CandidateProfile) {
  ...
  const birthDate = formatBirthDate(candidateProfile.birth_date);
          ...
          <div className='bg-white rounded-[24px] lg:rounded-[40px] shadow-[0px_0px_20px_0px_rgba(0,0,0,0.05)] p-6 lg:p-10 max-w-[728px] mx-auto'>
            <div className='space-y-6 lg:space-y-2'>
              ...
              <div className='lg:flex lg:gap-6'>
                ...
                <div className='px-4 lg:px-0 lg:py-6 lg:flex-1'>
                  <div className='flex gap-2 text-[16px] text-[#323232] tracking-[1.6px] font-medium'>
                    <span>{candidateProfile.last_name || '未設定'}</span>
                    <span>{candidateProfile.first_name || '未設定'}</span>
                  </div>
                </div>
              </div>
              ...
              <div className='lg:flex lg:gap-6'>
                ...
                <div className='px-4 lg:px-0 lg:py-6 lg:flex-1'>
                  <div className='flex gap-2 text-[16px] font-medium text-[#323232] tracking-[1.6px]'>
                    <span>{candidateProfile.last_name_kana || '未設定'}</span>
                    <span>{candidateProfile.first_name_kana || '未設定'}</span>
                  </div>
                </div>
              </div>
              ...
              <div className='lg:flex lg:gap-6'>
                ...
                <div className='px-4 lg:px-0 lg:py-6 lg:flex-1'>
                  <div className='text-[16px] font-medium text-[#323232] tracking-[1.6px]'>
                    {getGenderDisplay(candidateProfile.gender)}
                  </div>
                </div>
              </div>
              ...
              <div className='lg:flex lg:gap-6'>
                ...
                <div className='px-4 lg:px-0 lg:py-6 lg:flex-1'>
                  <div className='text-[16px] font-medium text-[#323232] tracking-[1.6px]'>
                    {candidateProfile.prefecture ||
                      candidateProfile.current_residence ||
                      '未設定'}
                  </div>
                </div>
              </div>
              ...
              <div className='lg:flex lg:gap-6'>
                ...
                <div className='px-4 lg:px-0 lg:py-6 lg:flex-1'>
                  <div className='text-[16px] font-medium text-[#323232] tracking-[1.6px]'>
                    {candidateProfile.phone_number || '未設定'}
                  </div>
                </div>
              </div>
