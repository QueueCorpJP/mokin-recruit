    ...
    <div className='flex flex-col min-h-screen isolate'>
      <main className='flex-1 relative z-[2]'>
        ...
        <div className='bg-[#f9f9f9] px-4 lg:px-20 py-6 lg:py-10 min-h-[730px]'>
          <div className='bg-white rounded-3xl lg:rounded-[40px] shadow-[0px_0px_20px_0px_rgba(0,0,0,0.05)] p-6 pb-6 pt-10 lg:p-10 w-full max-w-[728px] mx-auto'>
                ...
                <div key={i} className='flex flex-col lg:flex-row lg:gap-6'>
                  ...
                  <div className='px-4 lg:px-0 lg:py-6 lg:flex-1'>
                    <div className='flex flex-wrap gap-2'>
                      {[...Array(4)].map((_, j) => (
                        <div key={j} className='h-7 w-24 bg-[#d2f1da] rounded animate-pulse' />
                      ))}
                    </div>
                  </div>
                </div>
