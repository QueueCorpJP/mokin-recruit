          ...
          <div className="bg-white rounded-[10px] p-10">
            <div className="flex flex-col gap-2">
                  ...
                  <div className="flex flex-col gap-2">
                    <SelectInput
                      ...
                      onChange={(value) =>
                        setFormData({
                          ...formData,
                          location: { ...formData.location, prefecture: value },
                        })
                      }
                      placeholder="都道府県を選択"
                    />
              ...
              <div className="flex gap-6">
                ...
                <div className="flex-1 py-6">
                  <SelectInput
                    options={companyPhases.map((p) => ({ value: p, label: p }))}
              ...
              <div className="flex gap-6">
                ...
                <div className="flex-1 py-6">
                  <div className="flex flex-wrap gap-4">
                      ...
                      >
                        <input
                          ...
                          onChange={(e) => {
                            ...
                            if (file) {
                              // 既存画像を削除して、新しい画像を追加
                              const newUrls = formData.currentImageUrls.filter(
                                (_, i) => i !== index,
                              );
                    ...
                    {/* 画像追加ボタン（合計3枚まで） */}
                    {formData.currentImageUrls.length + formData.images.length <
                      3 && (
                      <ImageUpload
                        images={[]}
                        onChange={(newFiles) => {
