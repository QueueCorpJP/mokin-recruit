...
export default async function AccountPage() {
  ...
  const companyPromise = supabase
    ...
    .select(
      `id, company_name, representative_name, representative_position, industry, industries, company_overview, headquarters_address, icon_image_url, company_images, company_urls, established_year, capital_amount, capital_unit, employees_count, company_phase, company_attractions`
    )
  ...
  const companyProps = company
    ? {
        ...
        imageUrls: Array.isArray(company.company_images)
  ...
  return (
    <>
      <Account company={companyProps} groups={groupsWithMembers} />
    </>
  );
}
