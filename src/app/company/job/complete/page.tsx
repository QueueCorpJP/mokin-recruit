                ...
                <div className='box-border content-stretch flex flex-col gap-10 items-center justify-start p-[80px] w-full'>
                  ...
                  <div className='flex flex-wrap gap-4 items-start justify-center'>
                    <button
                      ...
                      className="box-border flex items-center justify-center min-w-40 px-10 py-3.5 rounded-[32px] w-[248px] border border-[#0f9058] border-solid bg-transparent relative font-['Noto_Sans_JP'] font-bold text-[#0f9058] text-[16px] text-center tracking-[1.6px] leading-[2] whitespace-pre transition-all duration-200 ease-in-out hover:bg-[rgba(15,144,88,0.2)] focus-visible:ring-[#0f9058]/30"
                    >
                      <span>他の求人も続けて登録</span>
                    </button>
                    <button
                      onClick={handleViewJobList}
                      className="box-border flex items-center justify-center min-w-40 px-10 py-3.5 rounded-[32px] shadow-[0px_5px_10px_0px_rgba(0,0,0,0.15)] bg-gradient-to-r from-[#198D76] to-[#1CA74F] font-['Noto_Sans_JP'] font-bold text-[#ffffff] text-[16px] text-center tracking-[1.6px] leading-[2] whitespace-pre transition-all duration-200 ease-in-out hover:bg-[linear-gradient(to_right,#12614E,#1A8946)] focus-visible:ring-[#198D76]/30"
                    >
                      <span>作成した求人一覧を見る</span>
                    </button>
                  </div>
                </div>
              </div>
