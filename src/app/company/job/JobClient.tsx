...
import { getJobForEdit, deleteJob } from './actions';
...
export default function JobClient({ initialJobs, initialGroups, initialConditions }: JobClientProps) {
  ...
  useEffect(() => {
    ...
    setSelectedStatus(initialConditions.status);
    setSelectedGroup(initialConditions.groupId);
    setSelectedScope(initialConditions.scope);
    setSearchKeyword(initialConditions.search);
        ...
        <div className='w-full px-[80px] py-[40px] bg-[#F9F9F9]'>
          <div className='max-w-[1280px] mx-auto w-full pb-[80px]'>
            ...
            <div className='rounded-t-lg flex flex-col items-center justify-center'>
              <div className="max-w-[1280px] w-full mx-auto flex gap-[24px] border-b border-[#DCDCDC] text-[#222] text-[14px] font-bold font-['Noto_Sans_JP'] px-[24px] pb-2">
                ...
                <div className='w-[64px] text-right'>操作</div>
              </div>
