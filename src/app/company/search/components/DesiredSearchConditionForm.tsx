                  ...
                  >
                    ...
                    <div className="bg-[#d2f1da] h-[40px] flex items-center px-4 relative">
                      <select
                        ...
                        onFocus={() => setOpenSelectId(`desired-job-${job.id}`)}
                        onBlur={() => setOpenSelectId(null)}
                        onChange={(e) => {
                          const updatedJobTypes = searchStore.desiredJobTypes.map(j => 
                            j.id === job.id ? { ...j, experienceYears: e.target.value } : j
                          );
                      ...
                      <svg
                        ...
                        viewBox="0 0 14 10"
                        fill="none"
                        className={`absolute right-2 pointer-events-none transition-transform duration-300 ${openSelectId === `desired-job-${job.id}` ? 'rotate-180' : ''}`}
                        style={{
                          top: '50%',
                          transform: `translateY(-50%) ${openSelectId === `desired-job-${job.id}` ? 'rotate(180deg)' : 'rotate(0deg)'}`,
                        }}
                      >
                        <path
                  ...
                  >
                    ...
                    <div className="bg-[#d2f1da] h-[40px] flex items-center px-4 relative">
                      <select
                        ...
                        onChange={(e) => {
                          const updatedIndustries = searchStore.desiredIndustries.map(i => 
                            i.id === industry.id ? { ...i, experienceYears: e.target.value } : i
                          );
                      ...
                      <svg
                        ...
                        style={{
                          top: '50%',
                          transform: `translateY(-50%) ${openSelectId === `industry-${industry.id}` ? 'rotate(180deg)' : 'rotate(0deg)'}`,
                        }}
                      >
                        <path
                          d="M6.07178 8.90462L0.234161 1.71483C-0.339509 1.00828 0.206262 0 1.16238 0H12.8376C13.7937 0 14.3395 1.00828 13.7658 1.71483L7.92822 8.90462C7.46411 9.47624 6.53589 9.47624 6.07178 8.90462Z"
