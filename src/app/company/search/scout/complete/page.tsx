...
// Multi-line Field Row Component
        ...
        <div className="max-w-[1200px] mx-auto">
          ...
          <div className="bg-white rounded-[10px] p-10">
            <div className="flex flex-col gap-2">
              {/* Sample Data - These would be populated from form data in real implementation */}
              ...
              <FieldRow
                ...
                isIdField
              />
              <FieldRow label="スカウトテンプレート" value="テキストが入ります。" />
              <FieldRow
                label="件名"
                value="テキストが入ります。"
              />
