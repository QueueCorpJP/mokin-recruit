...
export default function SettingsClient({
  ...
  const [userSettings] = useState<CompanyUserSettings | null>(
    initialUserSettings
  );
  const [notifications, setNotifications] =
    useState<CompanyNotificationSettingLocal>({
      applicationNotification:
        initialNotifications?.application_notification ?? 'receive',
      messageNotification:
        initialNotifications?.message_notification ?? 'receive',
      recommendationNotification:
        initialNotifications?.system_notification ?? 'receive',
    });

  const handleNotificationChange =
    (type: keyof CompanyNotificationSettingLocal) =>
    (e: React.ChangeEvent<HTMLInputElement>) => {
      ...
      formData.append(
        'applicationNotification',
        newNotifications.applicationNotification
      );
      formData.append(
        'messageNotification',
        newNotifications.messageNotification
      );
      formData.append(
        'recommendationNotification',
        newNotifications.recommendationNotification
      );
    ...
    <div className='min-h-screen bg-[#f9f9f9]'>
      ...
      <div className='px-4 md:px-20 py-10'>
        <div className='bg-white rounded-[10px] p-4 md:p-10'>
                    ...
                    <div className='flex flex-col gap-2 items-start justify-start'>
                      <div className='flex flex-wrap gap-4 items-center justify-start'>
                        <div className='flex gap-2 items-center justify-start'>
                          ...
                          >
                            <p className='leading-[2] whitespace-pre'>
                              受け取る
                            </p>
                          </label>
                        </div>
          ...
          <p className='text-sm md:text-base text-[#323232] tracking-[1.2px] md:tracking-[1.6px] font-medium'>
            休会・退会をご希望の場合は、
            <a href='/company/contact' className='text-[#0f9058]'>
              お問い合わせフォーム
            </a>
            よりご連絡ください
          </p>
