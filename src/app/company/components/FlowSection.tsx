    ...
    return (
      <section className='py-20 flex flex-col items-center'>
        <div className='w-full max-w-[1200px] flex flex-col items-center'>
          ...
          {/* フロー部分 */}
          <div className='mt-16  flex flex-col md:flex-row justify-center w-full items-center gap-[24px] md:gap-[16px]'>
             {steps.map((step, idx) => (
             <div key={step.label} className='flex md:flex-row items-center justify-center flex-col'>
                <div
                  key={step.label}
                  className='flex md:flex-col items-center justify-start w-[288px] md:w-[180px] h-auto md:h-[110px] flex-raw'
                >
                  {/* アイコン部 */}
