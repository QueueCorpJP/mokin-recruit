...
export default function SignupRecentJobPage() {
  ...
  const _removeJobHistory = (index: number) => {
  ...
  const updateJobHistory = (
    index: number,
    updates: Partial<RecentJobFormData>
  ) => {
          ...
          <div className='bg-white rounded-[40px] shadow-[0px_0px_20px_0px_rgba(0,0,0,0.05)] p-20 w-[1000px] flex flex-col gap-10 items-center'>
            ...
            <div className='flex flex-col gap-6 w-fit items-end'>
              ...
              <div className='flex flex-row gap-4 items-start w-full'>
                ...
                <div className='w-[400px]'>
                  <CompanyNameInput
                    ...
                    onChange={value =>
                      updateJobHistory(editingIndex, { companyName: value })
                    }
                    placeholder='企業名を入力'
                    className='w-full px-[11px] py-[11px] bg-white border border-[#999999] rounded-[5px] text-[16px] text-[#323232] font-medium tracking-[1.6px] placeholder:text-[#999999] placeholder:font-[580]'
                  />
                </div>
              </div>
              ...
              <div className='flex flex-row gap-4 items-start w-full'>
                ...
                <div className='w-[400px]'>
                  <input
                    ...
                    onChange={e =>
                      updateJobHistory(editingIndex, {
                        departmentPosition: e.target.value,
                      })
                    }
                    className='w-full px-[11px] py-[11px] bg-white border border-[#999999] rounded-[5px] text-[16px] text-[#323232] font-medium tracking-[1.6px] placeholder:text-[#999999] placeholder:font-[580]'
                  />
                ...
                <div className='w-[400px]'>
                  <div className='flex flex-wrap gap-2 items-center'>
                    <SelectInput
                      ...
                      onChange={value =>
                        updateJobHistory(editingIndex, { startYear: value })
                      }
                      options={[
                        { value: '', label: '未選択' },
                    ...
                    <SelectInput
                      ...
                      onChange={value =>
                        updateJobHistory(editingIndex, { startMonth: value })
                      }
                      options={[
                        { value: '', label: '未選択' },
                    ...
                    <div className='flex flex-col gap-2'>
                      <div className='flex flex-wrap gap-2 items-center'>
                        <SelectInput
                          ...
                          onChange={value =>
                            updateJobHistory(editingIndex, { endYear: value })
                          }
                          options={[
                            { value: '', label: '未選択' },
                        ...
                        <SelectInput
                          ...
                          onChange={value =>
                            updateJobHistory(editingIndex, { endMonth: value })
                          }
                          options={[
                            { value: '', label: '未選択' },
                            ...monthOptions.map(month => ({
              ...
              <div className='flex flex-row gap-4 items-start w-full'>
                ...
                <div className='w-[400px]'>
                  <div className='p-[1px] border border-[#999999] rounded-[5px]'>
                    <textarea
                      ...
                      className='leading-[200%] w-full px-[11px] py-[11px] bg-white text-[16px] text-[#323232] font-medium tracking-[1.6px] placeholder:text-[#999999] min-h-[160px] resize-none border-none outline-none'
                    />
                  </div>
                </div>
              </div>
                  ...
                  >
                    ...
                    >
                      <path
                        d='M2.85714 0C1.28125 0 0 1.28125 0 2.85714V17.1429C0 18.7188 1.28125 20 2.85714 20H17.1429C18.7188 20 20 18.7188 20 17.1429V2.85714C20 1.28125 18.7188 0 17.1429 0H2.85714ZM15.0446 7.90179L9.33036 13.6161C8.91071 14.0357 8.23214 14.0357 7.81696 13.6161L4.95982 10.7589C4.54018 10.3393 4.54018 9.66071 4.95982 9.24554C5.37946 8.83036 6.05804 8.82589 6.47321 9.24554L8.57143 11.3438L13.5268 6.38393C13.9464 5.96429 14.625 5.96429 15.0402 6.38393C15.4554 6.80357 15.4598 7.48214 15.0402 7.89732L15.0446 7.90179Z'
                        fill={
                          currentJob.isCurrentlyWorking ? '#0F9058' : '#DCDCDC'
                        }
                      />
                    </svg>
                  </div>
              ...
              <div className='flex flex-col gap-2'>
                ...
                <div className='p-[1px] border border-[#999999] rounded-[5px]'>
                  <textarea
                    ...
                    className='leading-[200%] w-full px-[11px] py-[11px] bg-white text-[16px] text-[#323232] font-medium tracking-[1.6px] placeholder:text-[#999999] min-h-[192px] resize-none border-none outline-none'
                  />
                </div>
              </div>
            </div>
