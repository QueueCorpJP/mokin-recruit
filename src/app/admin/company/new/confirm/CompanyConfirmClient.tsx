...
export default function CompanyConfirmClient() {
  ...
  return (
    <div className='max-w-4xl mx-auto space-y-6 p-6'>
      {/* ページタイトル */}
      <div className='mb-8'>
        <h1 className="font-['Noto_Sans_JP'] text-[24px] font-bold text-[#323232] leading-[1.6] tracking-[1.6px] mb-2">
          企業情報詳細
        </h1>
      ...
      <div className='space-y-4'>
        <h2 className="font-['Noto_Sans_JP'] text-[20px] font-bold text-[#323232] leading-[1.6] tracking-[1.6px] mb-4">
          企業情報
        </h2>
        ...
        <div className='flex items-center gap-6 py-3'>
          ...
          <div className='flex-1 space-y-2'>
            <div className="px-[11px] py-[11px] bg-white border border-[#999999] rounded-[5px] font-['Noto_Sans_JP'] text-[16px] font-medium text-[#323232] leading-[1.6] tracking-[1.6px]">
              {companyData.representativeName}
            </div>
            {companyData.representativePosition && (
              <div className="px-[11px] py-[11px] bg-gray-50 border border-[#999999] rounded-[5px] font-['Noto_Sans_JP'] text-[14px] font-medium text-[#666666] leading-[1.6] tracking-[1.6px]">
                役職: {companyData.representativePosition}
              </div>
            )}
          </div>
        </div>
