              ...
              <div className='flex items-center gap-8 mb-6'>
                ...
                <div className='w-[400px] flex gap-4'>
                  <input
                    ...
                    onChange={e =>
                      updateFormData('lastNameKana', e.target.value)
                    }
                    className='flex-1 px-[11px] py-[11px] border border-[#999999] rounded-[5px] text-[16px] text-[#323232] font-bold tracking-[1.6px] placeholder:text-[#999999]'
                  />
                  <input
                    ...
                    onChange={e =>
                      updateFormData('firstNameKana', e.target.value)
                    }
                    className='flex-1 px-[11px] py-[11px] border border-[#999999] rounded-[5px] text-[16px] text-[#323232] font-bold tracking-[1.6px] placeholder:text-[#999999]'
                  />
                </div>
                ...
                <div className='w-[400px]'>
                  <div className='relative'>
                    <select
                      ...
                      onChange={e =>
                        updateFormData('prefecture', e.target.value)
                      }
                ...
                <div className='w-[400px]'>
                  <div className='relative'>
                    <select
                      ...
                      onChange={e =>
                        updateFormData('currentIncome', e.target.value)
                      }
                      className='w-full px-[11px] py-[11px] pr-10 border border-[#999999] rounded-[5px] text-[16px] text-[#323232] font-bold tracking-[1.6px] appearance-none cursor-pointer'
                    >
                  ...
                  <div className='w-[400px]'>
                    <div className='relative'>
                      <select
                        ...
                        onChange={e =>
                          updateFormData('jobChangeTiming', e.target.value)
                        }
                        className='w-full px-[11px] py-[11px] pr-10 border border-[#999999] rounded-[5px] text-[16px] text-[#323232] font-bold tracking-[1.6px] appearance-none cursor-pointer'
                      >
                  ...
                  <div className='w-[400px]'>
                    <div className='relative'>
                      <select
                        ...
                        onChange={e =>
                          updateEducation('final_education', e.target.value)
                        }
                        className='w-full px-[11px] py-[11px] pr-10 border border-[#999999] rounded-[5px] text-[16px] text-[#323232] font-bold tracking-[1.6px] appearance-none cursor-pointer'
                      >
                        <option value=''>未選択</option>
                ...
                <div className='flex items-center gap-8 mb-6'>
                  ...
                  <div className='w-[400px]'>
                    <input
                      ...
                      onChange={e =>
                        updateEducation('school_name', e.target.value)
                      }
                ...
                <div className='w-[400px]'>
                  <div className='relative'>
                    <select
                      ...
                      onChange={e =>
                        updateSkills('english_level', e.target.value)
                      }
                      className='w-full px-[11px] py-[11px] pr-10 border border-[#999999] rounded-[5px] text-[16px] text-[#323232] font-bold tracking-[1.6px] appearance-none cursor-pointer'
                    >
                ...
                <div className='w-[400px]'>
                  <div className='border p-1'>
                    <textarea
                      ...
                      onChange={e =>
                        updateSkills('qualifications', e.target.value)
                      }
                    ...
                    {formData.desiredWorkStyles?.map((workStyle, index) => (
                      ...
                      >
                        ...
                        <button
                          ...
                          onClick={() => {
                            const newWorkStyles =
                              formData.desiredWorkStyles?.filter(
                                (_, i) => i !== index
                              ) || [];
