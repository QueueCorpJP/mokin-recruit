...
import {} from // JOB_CHANGE_TIMING_OPTIONS,
// CURRENT_ACTIVITY_STATUS_OPTIONS,
// PROGRESS_STATUS_OPTIONS,
// DECLINE_REASON_OPTIONS,
'@/constants/career-status';
...
export default function CandidateNewClientRefactored() {
  ...
  const {
    ...
    skills,
    selectionEntries: _selectionEntries,
    skillInput,
    memo,
    isSubmitting,
    updateFormData,
    ...
    updateSelectionEntry: _updateSelectionEntry,
    addSelectionEntry: _addSelectionEntry,
    removeSelectionEntry: _removeSelectionEntry,
    setSkillInput,
    addSkillTag,
    removeSkillTag,
    setMemo,
  ...
  const {
    modalState,
    selectedIndustriesMap: _selectedIndustriesMap,
    handleIndustryConfirm,
    handleJobTypeConfirm,
    openIndustryModal: _openIndustryModal,
    openJobTypeModal: _openJobTypeModal,
    closeModal,
    removeIndustryFromSelection: _removeIndustryFromSelection,
    removeRecentJobIndustry: _removeRecentJobIndustry,
    removeRecentJobType: _removeRecentJobType,
  } = useCandidateModals();
              ...
              <div className='flex items-start gap-8 mb-6'>
                ...
                <div className='w-[400px]'>
                  ...
                  <p className='text-[#999999] text-[14px] font-medium tracking-[1.4px] mt-2'>
                    ※最低3つ以上のキーワードを選択/登録してください。（現在:{' '}
                    {skills.skills_tags.length}個）
                  </p>
                </div>
              </div>
            </section>
