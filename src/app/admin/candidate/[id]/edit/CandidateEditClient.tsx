...
export default function CandidateEditClient({ candidate }: Props) {
  ...
  const [formData, setFormData] = useState<UpdateCandidateData>({
    ...
    recent_job_is_currently_working:
      candidate.recent_job_is_currently_working || false,
  ...
  const handleAddLanguage = () => {
    ...
    if (currentLanguages.length < 5) {
      setSkills(prev => ({
        ...prev,
        other_languages: [...currentLanguages, { language: '', level: '' }],
      }));
    }
  };
  ...
  const addSkillTag = () => {
    if (skillInput.trim() && !skills.skills_list.includes(skillInput.trim())) {
      setSkills(prev => ({
        ...prev,
        skills_list: [...prev.skills_list, skillInput.trim()],
      }));
      setSkillInput('');
    }
  };
  ...
  const getModalInitialData = (
    modalType: 'industry' | 'jobtype' | 'location' | 'workstyle',
    targetIndex: number
  ) => {
  ...
  const handleWorkStyleConfirm = (
    selectedWorkStyles: { id: string; name: string }[]
  ) => {
    const { targetIndex } = modalState;
  ...
  const validateForm = async () => {
    ...
    if (!formData.email) {
      ...
      if (!emailRegex.test(formData.email)) {
        ...
        try {
          const result = await checkEmailDuplication(
            formData.email,
            candidate.id
          );
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const cleanedSkills = {
        ...skills,
        other_languages:
          skills.other_languages?.filter(
            lang => lang && (lang.language || lang.level)
          ) || [],
      };
  ...
  const birthYear = formData.birth_date
    ? formData.birth_date.split('-')[0]
    : '';
  const birthMonth = formData.birth_date
    ? formData.birth_date.split('-')[1]
    : '';
        ...
        <div className='p-8'>
          ...
          <form onSubmit={e => e.preventDefault()}>
              ...
              <div className='flex items-center gap-8 mb-6'>
                ...
                <div className='w-[400px] flex gap-4'>
                  <input
                    ...
                    onChange={e =>
                      handleInputChange('last_name_kana', e.target.value)
                    }
                    className='flex-1 px-[11px] py-[11px] border border-[#999999] rounded-[5px] text-[16px] text-[#323232] font-bold tracking-[1.6px] placeholder:text-[#999999]'
                  />
                  <input
                    ...
                    onChange={e =>
                      handleInputChange('first_name_kana', e.target.value)
                    }
                    className='flex-1 px-[11px] py-[11px] border border-[#999999] rounded-[5px] text-[16px] text-[#323232] font-bold tracking-[1.6px] placeholder:text-[#999999]'
                  />
                </div>
                    ...
                    <select
                      ...
                      onChange={e => {
                        const newDate = `${e.target.value || ''}-${
                          birthMonth.padStart(2, '0') || '01'
                        }-${birthDay.padStart(2, '0') || '01'}`;
                        handleInputChange(
                          'birth_date',
                  ...
                  <div className='relative flex-1'>
                    <select
                      ...
                      onChange={e => {
                        ...
                        }-${e.target.value.padStart(2, '0') || '01'}-${
                          birthDay.padStart(2, '0') || '01'
                        }`;
                        handleInputChange(
                          'birth_date',
                ...
                <div className='w-[400px]'>
                  <div className='relative'>
                    <select
                      ...
                      onChange={e =>
                        handleInputChange('current_income', e.target.value)
                      }
                      className='w-full px-[11px] py-[11px] pr-10 border border-[#999999] rounded-[5px] text-[16px] text-[#323232] font-bold tracking-[1.6px] appearance-none cursor-pointer'
                    >
            ...
            <section className='mb-12'>
                ...
                <div className='flex items-center gap-8 mb-6'>
                  ...
                  <div className='w-[400px] flex gap-2'>
                    <button
                      type='button'
                      onClick={() =>
                        handleInputChange('has_career_change', 'yes')
                      }
                      className={`flex-1 px-[11px] py-[11px] border rounded-[5px] text-[16px] font-bold tracking-[1.6px] transition-colors ${
                    ...
                    <button
                      type='button'
                      onClick={() =>
                        handleInputChange('has_career_change', 'no')
                      }
                      className={`flex-1 px-[11px] py-[11px] border rounded-[5px] text-[16px] font-bold tracking-[1.6px] transition-colors ${
                  ...
                  <div className='w-[400px]'>
                    <div className='relative'>
                      <select
                        ...
                        onChange={e =>
                          handleInputChange('job_change_timing', e.target.value)
                        }
                        className='w-full px-[11px] py-[11px] pr-10 border border-[#999999] rounded-[5px] text-[16px] text-[#323232] font-bold tracking-[1.6px] appearance-none cursor-pointer'
                      >
              ...
              {formData.current_activity_status !== 'not_started' &&
                formData.current_activity_status !== 'researching' &&
                formData.current_activity_status !== '' && (
                  ...
                  <div className='w-[400px]'>
                    <div className='relative'>
                      ...
                      >
                        ...
                        <option value='高等専門学校卒業'>
                          高等専門学校卒業
                        </option>
                        <option value='短期大学卒業'>短期大学卒業</option>
                        <option value='専門学校卒業'>専門学校卒業</option>
                        <option value='大学卒業（学士）'>
                          大学卒業（学士）
                        </option>
                        <option value='大学院修士課程修了（修士）'>
                          大学院修士課程修了（修士）
                        </option>
                        <option value='大学院博士課程修了（博士）'>
                          大学院博士課程修了（博士）
                        </option>
                        <option value='海外大学卒業（学士）'>
                          海外大学卒業（学士）
                        </option>
                        <option value='海外大学院修了（修士・博士含む）'>
                          海外大学院修了（修士・博士含む）
                        </option>
                ...
                <div className='flex items-center gap-8 mb-6'>
                  ...
                  <div className='w-[400px]'>
                    <input
                      ...
                      onChange={e =>
                        handleEducationChange('school_name', e.target.value)
                      }
                ...
                <div className='flex items-center gap-8 mb-6'>
                  ...
                  <div className='w-[400px]'>
                    <input
                      ...
                      onChange={e =>
                        handleEducationChange('department', e.target.value)
                      }
                      className='w-full px-[11px] py-[11px] border border-[#999999] rounded-[5px] text-[16px] text-[#323232] font-medium tracking-[1.6px] placeholder:text-[#999999]'
                    />
                  </div>
                      ...
                      {formData.recent_job_industries.map((industry, index) => (
                        ...
                        >
                          ...
                          <button
                            ...
                            onClick={() => {
                              const newIndustries =
                                formData.recent_job_industries.filter(
                                  (_, i) => i !== index
                                );
                              handleInputChange(
                                'recent_job_industries',
                      ...
                      {formData.recent_job_types.map((jobType, index) => (
                        ...
                        >
                          ...
                          <button
                            ...
                            onClick={() => {
                              const newJobTypes =
                                formData.recent_job_types.filter(
                                  (_, i) => i !== index
                                );
                              handleInputChange(
                                'recent_job_types',
            ...
            <section className='mb-12'>
                ...
                <div className='w-[400px]'>
                  <div className='relative'>
                    <select
                      ...
                      onChange={e =>
                        handleSkillsChange('english_level', e.target.value)
                      }
                      className='w-full px-[11px] py-[11px] pr-10 border border-[#999999] rounded-[5px] text-[16px] text-[#323232] font-bold tracking-[1.6px] appearance-none cursor-pointer'
                    >
              ...
              {/* その他の言語 */}
              {skills.other_languages &&
                Array.isArray(skills.other_languages) &&
                skills.other_languages.map((field, index) => (
              ...
              {(!skills.other_languages ||
                ...
                <div className='flex items-center gap-8 mb-6'>
                  ...
                  >
                    ...
                    <span className='text-[#0f9058] text-[14px] font-bold'>
                      言語を追加
                    </span>
                  </button>
                </div>
                ...
                <div className='w-[400px]'>
                  <div className='relative'>
                    <select
                      ...
                      onChange={e =>
                        handleInputChange('desired_salary', e.target.value)
                      }
                      className='w-full px-[11px] py-[11px] pr-10 border border-[#999999] rounded-[5px] text-[16px] text-[#323232] font-bold tracking-[1.6px] appearance-none cursor-pointer'
                    >
                      <option value=''>希望年収を選択</option>
                      <option value='300万円未満'>300万円未満</option>
                      <option value='300万円〜400万円未満'>
                        300万円〜400万円未満
                      </option>
                      <option value='400万円〜500万円未満'>
                        400万円〜500万円未満
                      </option>
                      <option value='500万円〜600万円未満'>
                        500万円〜600万円未満
                      </option>
                      <option value='600万円〜700万円未満'>
                        600万円〜700万円未満
                      </option>
                      <option value='700万円〜800万円未満'>
                        700万円〜800万円未満
                      </option>
                      <option value='800万円〜900万円未満'>
                        800万円〜900万円未満
                      </option>
                      <option value='900万円〜1000万円未満'>
                        900万円〜1000万円未満
                      </option>
                    ...
                    {formData.desired_industries?.map((industry, index) => (
                      ...
                      >
                        ...
                        <button
                          ...
                          onClick={() => {
                            const newIndustries =
                              formData.desired_industries?.filter(
                                (_, i) => i !== index
                              ) || [];
                            handleInputChange(
                              'desired_industries',
                    ...
                    {formData.desired_job_types?.map((jobType, index) => (
                      ...
                      >
                        ...
                        <button
                          ...
                          onClick={() => {
                            const newJobTypes =
                              formData.desired_job_types?.filter(
                                (_, i) => i !== index
                              ) || [];
                    ...
                    {formData.desired_locations?.map((location, index) => (
                      ...
                      >
                        ...
                        <button
                          ...
                          onClick={() => {
                            const newLocations =
                              formData.desired_locations?.filter(
                                (_, i) => i !== index
                              ) || [];
                            handleInputChange(
                              'desired_locations',
