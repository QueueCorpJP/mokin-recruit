...
export default function CandidateEditConfirmClient({
  candidate,
                    ...
                    <div className='box-border content-stretch flex items-start justify-start overflow-clip px-3 py-2.5 relative shrink-0 w-full'>
                      <div className='basis-0 font-normal grow leading-[0] min-h-px min-w-px not-italic relative shrink-0 text-[12px] text-black'>
                        <p className='leading-[1.3]'>
                          {scoutStats.scout_received_7days}
                        </p>
                      </div>
                    </div>
                  </div>
                    ...
                    <div className='box-border content-stretch flex items-start justify-start overflow-clip px-3 py-2.5 relative shrink-0 w-full'>
                      <div className='basis-0 font-normal grow leading-[0] min-h-px min-w-px not-italic relative shrink-0 text-[12px] text-black'>
                        <p className='leading-[1.3]'>
                          ...
                          {scoutStats.scout_received_7days > 0
                            ? ` (${Math.round((scoutStats.scout_opened_7days / scoutStats.scout_received_7days) * 100)}%)`
                            : ''}
                        </p>
                      </div>
                    </div>
                    ...
                    <div className='box-border content-stretch flex items-start justify-start overflow-clip px-3 py-2.5 relative shrink-0 w-full'>
                      <div className='basis-0 font-normal grow leading-[0] min-h-px min-w-px not-italic relative shrink-0 text-[12px] text-black'>
                        <p className='leading-[1.3]'>
                          ...
                          {scoutStats.scout_received_7days > 0
                            ? ` (${Math.round((scoutStats.scout_replied_7days / scoutStats.scout_received_7days) * 100)}%)`
                            : ''}
                        </p>
                      </div>
                    </div>
                    ...
                    <div className='box-border content-stretch flex items-start justify-start overflow-clip px-3 py-2.5 relative shrink-0 w-full'>
                      <div className='font-normal leading-[0] not-italic relative shrink-0 text-[12px] text-black text-nowrap'>
                        <p className='leading-[1.3] whitespace-pre'>
                          ...
                          {scoutStats.scout_received_7days > 0
                            ? ` (${Math.round((scoutStats.applications_7days / scoutStats.scout_received_7days) * 100)}%)`
                            : ''}
                        </p>
                      </div>
                    </div>
                ...
                <div className='bg-[rgba(255,255,255,0)] content-stretch flex items-start justify-start overflow-clip relative shrink-0 w-full'>
                  ...
                  <div className='basis-0 bg-[rgba(255,255,255,0)] content-stretch flex flex-col grow items-start justify-start min-h-px min-w-px relative self-stretch shrink-0'>
                    ...
                    <div className='box-border content-stretch flex items-start justify-start overflow-clip px-3 py-2.5 relative shrink-0 w-full'>
                      <div className='basis-0 font-normal grow leading-[0] min-h-px min-w-px not-italic relative shrink-0 text-[12px] text-black'>
                        <p className='leading-[1.3]'>
                          {scoutStats.scout_received_30days}
                        </p>
                      </div>
                    </div>
                  </div>
                    ...
                    <div className='box-border content-stretch flex items-start justify-start overflow-clip px-3 py-2.5 relative shrink-0 w-full'>
                      <div className='basis-0 font-normal grow leading-[0] min-h-px min-w-px not-italic relative shrink-0 text-[12px] text-black'>
                        <p className='leading-[1.3]'>
                          ...
                          {scoutStats.scout_received_30days > 0
                            ? ` (${Math.round((scoutStats.scout_opened_30days / scoutStats.scout_received_30days) * 100)}%)`
                            : ''}
                        </p>
                      </div>
                    </div>
                    ...
                    <div className='box-border content-stretch flex items-start justify-start overflow-clip px-3 py-2.5 relative shrink-0 w-full'>
                      <div className='basis-0 font-normal grow leading-[0] min-h-px min-w-px not-italic relative shrink-0 text-[12px] text-black'>
                        <p className='leading-[1.3]'>
                          ...
                          {scoutStats.scout_received_30days > 0
                            ? ` (${Math.round((scoutStats.scout_replied_30days / scoutStats.scout_received_30days) * 100)}%)`
                            : ''}
                        </p>
                      </div>
                    </div>
                    ...
                    <div className='box-border content-stretch flex items-start justify-start overflow-clip px-3 py-2.5 relative shrink-0 w-full'>
                      <div className='font-normal leading-[0] not-italic relative shrink-0 text-[12px] text-black text-nowrap'>
                        <p className='leading-[1.3] whitespace-pre'>
                          ...
                          {scoutStats.scout_received_30days > 0
                            ? ` (${Math.round((scoutStats.applications_30days / scoutStats.scout_received_30days) * 100)}%)`
                            : ''}
                        </p>
                      </div>
                    </div>
                    ...
                    <div className='box-border content-stretch flex items-start justify-start overflow-clip px-3 py-2.5 relative shrink-0 w-full'>
                      <div className='basis-0 font-normal grow leading-[0] min-h-px min-w-px not-italic relative shrink-0 text-[12px] text-black'>
                        <p className='leading-[1.3]'>
                          ...
                          {scoutStats.scout_received_total > 0
                            ? ` (${Math.round((scoutStats.scout_opened_total / scoutStats.scout_received_total) * 100)}%)`
                            : ''}
                        </p>
                      </div>
                    </div>
                    ...
                    <div className='box-border content-stretch flex items-start justify-start overflow-clip px-3 py-2.5 relative shrink-0 w-full'>
                      <div className='basis-0 font-normal grow leading-[0] min-h-px min-w-px not-italic relative shrink-0 text-[12px] text-black'>
                        <p className='leading-[1.3]'>
                          ...
                          {scoutStats.scout_received_total > 0
                            ? ` (${Math.round((scoutStats.scout_replied_total / scoutStats.scout_received_total) * 100)}%)`
                            : ''}
                        </p>
                      </div>
                    </div>
                    ...
                    <div className='box-border content-stretch flex items-start justify-start overflow-clip px-3 py-2.5 relative shrink-0 w-full'>
                      <div className='font-normal leading-[0] not-italic relative shrink-0 text-[12px] text-black text-nowrap'>
                        <p className='leading-[1.3] whitespace-pre'>
                          ...
                          {scoutStats.scout_received_total > 0
                            ? ` (${Math.round((scoutStats.applications_total / scoutStats.scout_received_total) * 100)}%)`
                            : ''}
                        </p>
                      </div>
                    </div>
          ...
          <section className='mb-8'>
            ...
            <div className='px-4 py-4 space-y-6'>
              ...
              <div className='flex gap-8'>
                ...
                <span className='text-gray-900 flex-1'>
                  {formData.updateData?.prefecture || '選択された内容を表示'}
                </span>
              </div>
              <div className='flex gap-8'>
                <span className='text-sm font-medium text-gray-700 w-[120px] text-right'>
                ...
                <div className='flex gap-2 items-center text-gray-900 flex-1'>
                  {formData.updateData?.birth_date ? (
                    <>
                      ...
                      <span>
                        {new Date(formData.updateData.birth_date).getMonth() +
                          1}
                      </span>
                      <span className='text-gray-600'>月</span>
                      <span>
                        {new Date(formData.updateData.birth_date).getDate()}
                      </span>
                      <span className='text-gray-600'>日</span>
                      {age && (
                        <span className='text-gray-600 ml-2'>({age}歳)</span>
                      )}
                    </>
                  ) : (
                    <>
              ...
              <div className='flex gap-8'>
                ...
                <span className='text-gray-900 flex-1'>
                  {formData.updateData?.phone_number || '入力された内容を表示'}
                </span>
              </div>
              <div className='flex gap-8'>
                <span className='text-sm font-medium text-gray-700 w-[120px] text-right'>
                ...
                <span className='text-gray-900 flex-1'>
                  {formData.updateData?.current_income ||
                    '選択された内容を表示'}
                </span>
              </div>
            </div>
          ...
          <section className='mb-8'>
            ...
            <div className='px-4 py-4 space-y-6'>
              <div className='flex gap-8'>
                ...
                <span className='text-gray-900 flex-1'>
                  {formData.updateData?.recent_job_company_name ||
                    '入力された内容を表示'}
                </span>
              </div>
              <div className='flex gap-8'>
              ...
              <div className='flex gap-8'>
                ...
                <div className='flex flex-col gap-2 flex-1'>
                  {formData.updateData?.recent_job_industries &&
                  formData.updateData.recent_job_industries.length > 0 ? (
                    formData.updateData.recent_job_industries.map(
              ...
              <div className='flex gap-8'>
                ...
                <div className='flex flex-col gap-2 flex-1'>
                  {formData.updateData?.recent_job_types &&
                  formData.updateData.recent_job_types.length > 0 ? (
                    formData.updateData.recent_job_types.map(
                      (jobType: string, index: number) => (
                        <span
                          key={index}
                          className="inline-block px-3 py-1 rounded-[5px] bg-[#D2F1DA] text-[#0F9058] font-['Noto_Sans_JP'] text-[14px] font-bold leading-[1.6] tracking-[1.4px] w-fit"
                        >
              ...
              <div className='flex gap-8'>
                ...
                <div className='text-gray-900 whitespace-pre-wrap flex-1'>
                  {formData.updateData?.recent_job_description ||
                    '入力された業務内容を表示'}
                </div>
              </div>
            </div>
              ...
              <div>
                ...
                <div className='space-y-6'>
                  ...
                  <div className='flex gap-8'>
                    ...
                    <span className='text-gray-900 flex-1'>
                      {formData.education?.school_name || '未設定'}
                    </span>
                  </div>
                  <div className='flex gap-8'>
                    <span className='text-sm font-medium text-gray-700 w-[120px] text-right'>
                    ...
                    <span className='text-gray-900 flex-1'>
                      {formData.education?.department || '未設定'}
                    </span>
                  </div>
                  <div className='flex gap-8'>
                    <span className='text-sm font-medium text-gray-700 w-[120px] text-right'>
                    ...
                    <div className='flex gap-2 items-center text-gray-900 flex-1'>
                      <span>
                        {formData.education?.graduation_year || '未設定'}
                      </span>
                      <span className='text-gray-600'>年</span>
                      <span>
                        {formData.education?.graduation_month || '未設定'}
                      </span>
                      <span className='text-gray-600'>月</span>
                    </div>
                  </div>
              ...
              <div>
                ...
                <div className='space-y-4'>
                  ...
                  {(() => {
                    ...
                    console.log(
                      'Other languages debug:',
                      otherLanguages,
                      typeof otherLanguages
                    );
              ...
              <div>
                ...
                <div className='space-y-6'>
                  <div className='flex gap-8'>
                    ...
                    <div className='flex flex-col gap-2 flex-1'>
                      {formData.skills?.skills_list &&
                      formData.skills.skills_list.length > 0 ? (
                        formData.skills.skills_list.map(
          ...
          <section className='mb-8'>
            ...
            <div className='px-4 py-4 space-y-6'>
              <div className='flex gap-8'>
                ...
                <span className='text-gray-900 flex-1'>
                  {formData.updateData?.desired_salary ||
                    '選択された内容を表示'}
                </span>
              </div>
              <div className='flex gap-8'>
                ...
                <div className='flex flex-wrap gap-2 flex-1'>
                  {formData.updateData?.desired_industries &&
                  formData.updateData.desired_industries.length > 0 ? (
                    formData.updateData.desired_industries.map(
                      (industry: string, index: number) => (
                        <span
                          key={index}
              ...
              <div className='flex gap-8'>
                ...
                <div className='flex flex-wrap gap-2 flex-1'>
                  {formData.updateData?.desired_job_types &&
                  formData.updateData.desired_job_types.length > 0 ? (
                    formData.updateData.desired_job_types.map(
                      (jobType: string, index: number) => (
                        <span
                          key={index}
                          className="inline-block px-3 py-1 rounded-[5px] bg-[#D2F1DA] text-[#0F9058] font-['Noto_Sans_JP'] text-[14px] font-bold leading-[1.6] tracking-[1.4px]"
              ...
              <div className='flex gap-8'>
                ...
                <div className='flex flex-wrap gap-2 flex-1'>
                  {formData.updateData?.desired_locations &&
                  formData.updateData.desired_locations.length > 0 ? (
                    formData.updateData.desired_locations.map(
              ...
              <div className='flex gap-8'>
                ...
                <div className='flex flex-col gap-2 flex-1'>
                  {formData.updateData?.desired_work_styles &&
                  formData.updateData.desired_work_styles.length > 0 ? (
                    formData.updateData.desired_work_styles.map(
