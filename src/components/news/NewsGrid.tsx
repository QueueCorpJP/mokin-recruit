...
export const NewsGrid: React.FC<NewsGridProps> = ({ 
  ...
  const handleArticleClick = useCallback((articleId: string) => {
    router.prefetch(`/candidate/news/${articleId}`);
      ...
      {hasMore && onLoadMore && (
        <div className="flex justify-center mt-[60px]">
          <button
            ...
            style={{ 
              fontWeight: 700,
              fontFamily: 'var(--font-noto-sans-jp), "Noto Sans JP", system-ui, -apple-system, BlinkMacSystemFont, "Segue UI", Roboto, sans-serif'
            }}
          >
