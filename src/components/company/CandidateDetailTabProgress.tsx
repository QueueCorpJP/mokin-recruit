...
const CandidateDetailTabProgress: React.FC<CandidateDetailTabProgressProps> = ({ candidate }) => {
  ...
  return (
    <div className="bg-white border border-[#D2F1DA] p-6" style={{ fontFamily: 'Noto Sans JP, sans-serif' }}>
      {/* 進捗情報 */}
      <div className="mb-8">
        <h3 className="text-[#0F9058] text-[18px] font-bold tracking-[1.8px] mb-4">進捗情報</h3>
        <div className="grid grid-cols-1 gap-4">
          <div>
            <span className="text-[#999999] text-[14px] font-bold tracking-[1.4px]">応募状況</span>
            <div className="text-[#323232] text-[16px] font-medium tracking-[1.6px] mt-1">
              応募済み
            </div>
          </div>
          <div>
            <span className="text-[#999999] text-[14px] font-bold tracking-[1.4px]">進捗ステータス</span>
            <div className="text-[#323232] text-[16px] font-medium tracking-[1.6px] mt-1">
              書類選考中
            </div>
          </div>
          <div>
            <span className="text-[#999999] text-[14px] font-bold tracking-[1.4px]">最終更新日時</span>
            <div className="text-[#323232] text-[16px] font-medium tracking-[1.6px] mt-1">
      ...
      {/* メモ・コメント */}
      <div className="mb-8">
        <h3 className="text-[#0F9058] text-[18px] font-bold tracking-[1.8px] mb-4">メモ・コメント</h3>
      ...
      {/* 履歴 */}
      <div className="mb-8">
        <h3 className="text-[#0F9058] text-[18px] font-bold tracking-[1.8px] mb-4">履歴</h3>
