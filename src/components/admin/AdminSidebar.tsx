...
const navigationItems = [
  {
    icon: (
      <Image src='/images/admin/home.svg' alt='home' width={20} height={20} />
    ),
    title: '管理画面ホーム',
    href: '/admin',
    subItems: [],
  ...
  {
    icon: (
      <Image src='/images/admin/mail.svg' alt='mail' width={20} height={20} />
    ),
    title: 'メッセージ',
    href: '/admin/message',
    subItems: [
  ...
  },
  {
    icon: (
      <Image
        src='/images/admin/candidate.svg'
        alt='users'
        width={20}
        height={20}
      />
  ...
  },
  {
    ...
    subItems: [{ title: '企業・候補者分析', href: '/admin/analytics' }],
  },
];
            ...
            <div className='pl-7 space-y-1'>
              {section.subItems.map(item => (
                <Link
                  ...
                  className='flex items-center gap-2 w-full hover:opacity-80 transition-opacity duration-150'
                >
                  <span className='text-[#323232] text-[12px] leading-[200%]'>
                    •
                  </span>
