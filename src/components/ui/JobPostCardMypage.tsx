...
interface JobPostCardMypageProps {
  imageUrl: string;
  imageAlt: string;
  className?: string;
  title: string;
...
export function JobPostCardMypage({
  imageUrl,
  imageAlt,
  className = '',
  title,
  ...
  const cardContent = (
    ...
    >
      ...
      >
        ...
        <Image
          src={imageUrl || '/images/default-job.jpg'}
          alt={imageAlt}
          width={isSimple ? 103.5 : 477}
          height={isSimple ? 69 : 318}
          style={{
        ...
        >
          ...
          {showCompanyInfo && companyIconUrl && variant === 'mypage-simple' && (
