...
export function JobPostCard({
  ...
  return (
    <div
      ...
      onClick={onClick}
    >
      <div className='flex flex-col md:flex-row justify-center items-center w-full h-full gap-8 p-6 relative'>
        ...
        <img
          src={imageUrl}
          alt={imageAlt}
          width={imageWidth ?? 477}
          height={imageHeight ?? 318}
          style={{
            width: imageWidth ?? 477,
            height: imageHeight ?? 318,
            objectFit: 'cover',
          ...
          className='object-cover rounded-[5px] md:w-[477px] md:h-[318px]'
        />
        <div
        ...
        >
          {variant === 'mypage-simple' ? (
            ...
            <>
              ...
              {/* location, salary, apellはvariantがmypage-simple以外のときのみ表示 */}
              {variant !== 'mypage-simple' && (
                <>
                  <div
              ...
              <div
                className='pt-4 border-t-0 md:border-t-2 md:border-t-[#EFEFEF] w-full static md:absolute md:left-0 md:bottom-0'
                style={{
                  borderTop: variant === 'mypage-simple' ? 'none' : undefined,
                }}
              >
                <div className='flex flex-row items-center'>
                  <div
