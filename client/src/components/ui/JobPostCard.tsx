        ...
        >
          ...
          <div className='flex flex-row gap-2 items-start flex-wrap md:flex-nowrap w-[277px]'>
            {tags.map((tag, idx) => (
              <span
                key={tag + idx}
                className='py-0.5 px-2 md:py-0 md:px-4 md:text-[16px] md:leading-[2] bg-[#d2f1da] rounded-[10px] text-[#0f9058] font-medium'
              >
                {tag}
              </span>
            ))}
          ...
          <div className='flex flex-row items-center mt-4 hidden md:flex'>
            ...
            <span className='ml-1 text-[16px]' style={{ color: '#323232' }}>
              {location}
            </span>
          </div>
