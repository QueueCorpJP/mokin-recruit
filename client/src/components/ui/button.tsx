    ...
    'aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive',
  {
    variants: {
      variant: {
        ...
        destructive:
          'bg-[var(--red-button-bg,#ff5b5b)] text-[var(--red-button-text,#ffffff)] shadow-xs hover:bg-[var(--red-button-hover-bg,#af4545)] focus-visible:ring-destructive/20 dark:focus-visible:ring-destructive/40 rounded-[var(--red-button-radius,32px)]',
