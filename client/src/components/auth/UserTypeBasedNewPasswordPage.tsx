...
function CandidateLoadingScreen({ message = '読み込み中...' }: { message?: string }) {
  return (
    <CandidateAuthBackground>
      <Navigation />
      <main className='flex-1 px-4 sm:px-6 md:px-[80px] pt-6 md:pt-[80px] mb-20 lg:mb-0 lg:pb-[280px] flex justify-center items-start relative w-full'>
...
export function UserTypeBasedNewPasswordPage() {
  ...
  if (userType === 'candidate') {
    ...
    return (
      <CandidateAuthBackground>
        <Navigation />
        <main className='flex-1 px-4 sm:px-6 md:px-[80px] pt-6 md:pt-[80px] mb-20 lg:mb-0 lg:pb-[400px] flex justify-center items-start relative w-full'>
