          ...
          >
            <div className="bg-white rounded-[40px] shadow-[0px_0px_20px_0px_rgba(0,0,0,0.05)] p-20 w-[1000px] flex flex-col gap-10 items-center">
                ...
                <div className="flex-1 flex flex-row gap-2 items-center justify-center py-2 px-6 border-b-3 border-[#0f9058]">
                  <div className="w-6 h-6 flex items-center justify-center">
                    <svg width="22" height="25" viewBox="0 0 22 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <path d="M10.9997 12.5C12.6162 12.5 14.1666 11.8679 15.3097 10.7426C16.4527 9.61742 17.0949 8.0913 17.0949 6.5C17.0949 4.9087 16.4527 3.38258 15.3097 2.25736C14.1666 1.13214 12.6162 0.5 10.9997 0.5C9.38312 0.5 7.83277 1.13214 6.68969 2.25736C5.54661 3.38258 4.90444 4.9087 4.90444 6.5C4.90444 8.0913 5.54661 9.61742 6.68969 10.7426C7.83277 11.8679 9.38312 12.5 10.9997 12.5ZM8.82348 14.75C4.13301 14.75 0.333008 18.4906 0.333008 23.1078C0.333008 23.8766 0.966341 24.5 1.74729 24.5H20.2521C21.033 24.5 21.6663 23.8766 21.6663 23.1078C21.6663 18.4906 17.8663 14.75 13.1759 14.75H8.82348Z" fill="#DCDCDC" />
                    </svg>
                  </div>
              ...
              <div className="text-[#323232] text-[16px] leading-8 tracking-[1.6px] text-center font-bold max-w-[792px]">
                <p>あなたの活動状況や志望企業を共有すると、あなたの志向や強みがより伝わりやすく、</p>
                ...
                <div className="flex flex-row gap-4 items-start w-fit mx-auto mb-4">
                  ...
                  <div className="flex flex-col gap-2 w-[400px]">
                    <div className="flex flex-row gap-2">
                      <button
                        type="button"
                        onClick={() => setFormData(prev => ({ ...prev, hasCareerChange: 'yes' }))}
                      ...
                      <button
                        type="button"
                        onClick={() => setFormData(prev => ({ ...prev, hasCareerChange: 'no' }))}
                        className={`flex-1 px-[11px] py-[11px] border rounded-[5px] text-[16px] font-bold tracking-[1.6px] transition-colors ${
                  ...
                  <div className="w-[400px]">
                    <div className="relative">
                      <select
                        ...
                        onChange={(e) => setFormData(prev => ({ ...prev, jobChangeTiming: e.target.value }))}
                  ...
                  <div className="w-[400px]">
                    <div className="relative">
                      <select
                        ...
                        onChange={(e) => setFormData(prev => ({ ...prev, currentActivityStatus: e.target.value }))}
                        className="w-full px-[11px] py-[11px] pr-10 bg-white border border-[#999999] rounded-[5px] text-[16px] font-bold tracking-[1.6px] appearance-none cursor-pointer text-[#323232]"
                      >
                        <option value="">未選択</option>
                        {CURRENT_ACTIVITY_STATUS_OPTIONS.map((option: { value: string; label: string }) => (
                          <option key={option.value} value={option.value}>
                            {option.label}
                          </option>
                        ))}
                    ...
                    >
                      ...
                      <div className="flex flex-row gap-4 items-start w-full">
                        ...
                        <div className="flex flex-col gap-2 w-[400px]">
                          <button
                            type="button"
                            onClick={() => setModalState({ isOpen: true, targetIndex: index })}
          ...
          >
            <div className="bg-white rounded-3xl shadow-[0px_0px_20px_0px_rgba(0,0,0,0.05)] px-6 py-10 mx-4 w-full flex flex-col gap-10 items-center">
              <div className="flex flex-row gap-4 items-center w-full pb-4 border-b border-[#efefef]">
                <div className="relative w-[72px] h-[72px]">
                  <svg width="72" height="72" viewBox="0 0 72 72" fill="none">
                    <circle cx="36" cy="36" r="28.8" stroke="#e0e0e0" strokeWidth="7.2" fill="none" strokeLinecap="round" transform="rotate(-90 36 36)" />
                    <circle cx="36" cy="36" r="28.8" stroke="#0f9058" strokeWidth="7.2" fill="none" strokeLinecap="round" strokeDasharray="120.64 60.32" transform="rotate(-90 36 36)" />
                  </svg>
                  <div className="absolute inset-0 flex items-center justify-center">
                    <div className="text-center">
                      <span className="text-[#0f9058] text-[24px] font-medium tracking-[2.4px]">2</span>
                      <span className="text-[#999999] text-[17px] font-medium tracking-[1.7px]">/3</span>
                    </div>
                  </div>
                </div>
                <div className="flex flex-col">
                  <p className="text-[#999999] text-[16px] font-bold tracking-[1.6px]">会員情報</p>
                  <p className="text-[#0f9058] text-[20px] font-bold tracking-[2px]">転職活動状況</p>
                </div>
              </div>

              <div className="text-[#323232] text-[16px] leading-8 tracking-[1.6px] text-center font-bold">
                <p>あなたの活動状況や志望企業を共有すると、あなたの志向や強みがより伝わりやすく、マッチしたスカウトが届きやすくなります。</p>
              </div>
              ...
              <div className="flex flex-col gap-6 w-full">
                ...
                {/* Job Change Timing */}
                <div className="flex flex-col gap-2">
                  <label className="text-[#323232] text-[16px] font-bold tracking-[1.6px]">転職希望時期</label>
                  <div className="relative">
                    <select
                      value={formData.jobChangeTiming}
                      onChange={(e) => setFormData(prev => ({ ...prev, jobChangeTiming: e.target.value }))}
                ...
                {/* Current Activity Status */}
                <div className="flex flex-col gap-2">
                  <label className="text-[#323232] text-[16px] font-bold tracking-[1.6px]">現在の活動状況</label>
                  <div className="relative">
                    <select
                      value={formData.currentActivityStatus}
                      onChange={(e) => setFormData(prev => ({ ...prev, currentActivityStatus: e.target.value }))}
              ...
              {formData.currentActivityStatus !== 'not_started' && formData.currentActivityStatus !== 'researching' && (
                <div className="flex flex-col gap-2 items-center w-full">
                  {formData.selectionEntries.map((entry, index) => (
                    <div key={entry.id} className="bg-[#f9f9f9] rounded-[10px] p-6 w-full flex flex-col gap-6 relative">
                      {index > 0 && (
                      ...
                      {/* Public Range Checkbox */}
                      <div className="flex flex-col gap-2">
                        <label className="text-[#323232] text-[16px] font-bold tracking-[1.6px]">公開範囲</label>
                        <div className="flex flex-row gap-2 items-start">
                          <div className="w-5 h-5 mt-1 cursor-pointer" onClick={() => updateEntry(index, 'isPrivate', !entry.isPrivate)}>
                            <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                              <path d="M2.85714 0C1.28125 0 0 1.28125 0 2.85714V17.1429C0 18.7188 1.28125 20 2.85714 20H17.1429C18.7188 20 20 18.7188 20 17.1429V2.85714C20 1.28125 18.7188 0 17.1429 0H2.85714ZM15.0446 7.90179L9.33036 13.6161C8.91071 14.0357 8.23214 14.0357 7.81696 13.6161L4.95982 10.7589C4.54018 10.3393 4.54018 9.66071 4.95982 9.24554C5.37946 8.83036 6.05804 8.82589 6.47321 9.24554L8.57143 11.3438L13.5268 6.38393C13.9464 5.96429 14.625 5.96429 15.0402 6.38393C15.4554 6.80357 15.4598 7.48214 15.0402 7.89732L15.0446 7.90179Z" fill={entry.isPrivate ? '#0F9058' : '#DCDCDC'} />
                            </svg>
                          </div>
                          <div className="flex flex-col gap-1 flex-1">
                            ...
                            <p className="text-[#999999] text-[14px] font-medium tracking-[1.4px] leading-[1.6]">
                              企業に選考状況を伝えることで、スカウトの質やあなたへの興味度が高まりやすくなります。<br />
                              ※選考中の企業には自動で非公開になります。
                            </p>
                          </div>
                        </div>
                      ...
                      {/* Industry Selection */}
                      <div className="flex flex-col gap-2">
                        <label className="text-[#323232] text-[16px] font-bold tracking-[1.6px]">業種</label>
                        <button
                          type="button"
                          onClick={() => setModalState({ isOpen: true, targetIndex: index })}
                      ...
                      {/* Company Name */}
                      <div className="flex flex-col gap-2">
                        <label className="text-[#323232] text-[16px] font-bold tracking-[1.6px]">企業名</label>
                        <CompanyNameInput
                          value={entry.companyName}
                          onChange={(value) => updateEntry(index, 'companyName', value)}
                          placeholder="企業名を入力"
                      ...
                      {/* Department */}
                      <div className="flex flex-col gap-2">
                        <label className="text-[#323232] text-[16px] font-bold tracking-[1.6px]">部署名・役職名</label>
                        <input
                          type="text"
                          value={entry.department || ''}
                          onChange={(e) => updateEntry(index, 'department', e.target.value)}
                      ...
                      {/* Progress Status */}
                      <div className="flex flex-col gap-2">
                        <label className="text-[#323232] text-[16px] font-bold tracking-[1.6px]">進捗状況</label>
                        <div className="relative">
                          <select
                            value={entry.progressStatus}
                            onChange={(e) => updateEntry(index, 'progressStatus', e.target.value)}
                      ...
                      {entry.progressStatus === 'declined' && (
                        <div className="flex flex-col gap-2">
                          <label className="text-[#323232] text-[16px] font-bold tracking-[1.6px]">辞退理由</label>
                          <div className="relative">
                            <select
                              value={entry.declineReason || ''}
                              onChange={(e) => updateEntry(index, 'declineReason', e.target.value)}
