...
export default function ProfileClient({ profile }: { profile: ProfileDTO }) {
              ...
              <div className='lg:flex lg:gap-6'>
                ...
                <div className='px-4 lg:px-0 lg:py-6 lg:flex-1'>
                  <div className='flex gap-2 text-[16px] font-medium text-[#323232] tracking-[1.6px]'>
                    <span>{profile.lastNameKana}</span>
                    <span>{profile.firstNameKana}</span>
                  </div>
                </div>
              </div>
              {/* 性別 */}
