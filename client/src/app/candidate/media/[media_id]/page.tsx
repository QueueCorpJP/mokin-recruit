          ...
          <div className="flex flex-col lg:flex-row lg:justify-between px-[16px] md:px-[80px]">
            ...
            <article className="flex-1 lg:pr-[80px]">
              ...
              <div className="mb-[32px]">
                <h1 className="text-[32px] text-[#323232] mb-[16px] font-noto-sans-jp leading-[1.5]" style={{ fontWeight: 700, fontFamily: 'Noto Sans JP, Noto Sans JP Fallback, system-ui, sans-serif' }}>
                  {article.title}
                </h1>
