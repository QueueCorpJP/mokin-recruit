...
const withdrawalReasons: SelectOption[] = [
  ...
  { value: 'no_matching_scouts', label: '希望条件に合致するスカウトがなかった' },
      ...
      >
        ...
        >
          ...
          >
            ...
            >
              <p className="block leading-[1.6]">退会理由を選択してください。</p>
            </div>
            <div
              className="leading-[2] relative shrink-0 text-[#323232] text-sm md:text-[16px] tracking-[1.2px] md:tracking-[1.6px] w-full"
            >
          ...
          <div
            className="box-border content-stretch flex flex-col md:flex-row gap-4 items-start md:items-center justify-center p-0 relative shrink-0 w-full"
          >
            <div
              className="box-border content-stretch flex flex-row gap-2.5 items-center justify-start px-0 relative shrink-0"
            >
              <div
                className="font-['Noto_Sans_JP:Bold',_sans-serif] leading-[0] not-italic relative shrink-0 text-[#323232] text-sm md:text-[16px] text-left text-nowrap tracking-[1.2px] md:tracking-[1.6px] font-medium"
              >
                <p className="adjustLetterSpacing block leading-[2] whitespace-pre font-bold">退会理由</p>
              </div>
            </div>
            <div
              className="box-border content-stretch flex flex-col gap-2 items-start justify-center p-0 relative shrink-0 w-full md:w-[400px]"
            >
              <SelectInput
        ...
        <div
          className="box-border content-stretch flex flex-col md:flex-row gap-4 items-stretch md:items-start justify-center md:justify-start p-0 relative shrink-0 w-full md:w-auto"
        >
          <Button
