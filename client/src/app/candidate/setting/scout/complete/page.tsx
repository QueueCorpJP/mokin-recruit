      ...
      >
        ...
        >
          ...
          >
            ...
            >
              <p className="block leading-[1.6]">スカウトステータスの変更が完了しました。</p>
            </div>
            <div 
              className="relative shrink-0 text-[#323232] text-[16px] tracking-[1.6px] font-medium w-full font-medium"
            >
              <p className="block leading-[2]">スカウトステータスに関わらず、求人への応募は可能です。</p>
            </div>
          </div>
        </div>
        <Button
