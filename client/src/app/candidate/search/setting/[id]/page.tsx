      ...
      try {
        ...
        if (response.success && response.data) {
          ...
          const mappedJobData: JobDetailData = {
            ...
            jobTypes: Array.isArray(apiJob.job_type) ? apiJob.job_type : [apiJob.job_type || '職種未設定'],
            industries: Array.isArray(apiJob.industry) ? apiJob.industry : [apiJob.industry || '業種未設定'],
            ...
            locations: Array.isArray(apiJob.work_location) ? apiJob.work_location : [apiJob.work_location || '勤務地未設定'],
            locationNote: apiJob.location_note || 'テキストが入ります。',
            employmentType: apiJob.employment_type || 'テキストが入ります。',
            employmentTypeNote: apiJob.employment_type_note || 'テキストが入ります。',
            ...
            appealPoints: {
              business: Array.isArray(apiJob.appeal_points?.business) ? apiJob.appeal_points.business : ['CxO候補', '新規事業立ち上げ'],
              company: Array.isArray(apiJob.appeal_points?.company) ? apiJob.appeal_points.company : ['成長フェーズ', '上場準備中'],
              team: Array.isArray(apiJob.appeal_points?.team) ? apiJob.appeal_points.team : ['少数精鋭', '代表と距離が近い'],
              workstyle: Array.isArray(apiJob.appeal_points?.workstyle) ? apiJob.appeal_points.workstyle : ['フレックス制度', 'リモートあり']
            },
            smoke: apiJob.smoking_policy || '屋内禁煙',
            resumeRequired: Array.isArray(apiJob.resume_required) ? apiJob.resume_required : ['履歴書の提出が必須', '職務経歴書の提出が必須'],
            // 企業情報
            ...
            industry: apiJob.company_industry || 'テキスト1、テキスト2、テキスト3',
          ...
          <div className="flex flex-col gap-10 items-start justify-start w-[880px]">
            ...
            <div className="flex flex-col gap-4 items-start justify-start w-full">
              ...
              <div 
                ...
                style={{ 
                  backgroundImage: jobData.images[0] ? `url(${jobData.images[0]})` : "url(data:image/svg+xml;base64,)" 
                }}
              />
              ...
              <div className="flex flex-row gap-1 items-center justify-start overflow-hidden rounded-[10px] w-full">
                ...
                <div className="flex-1 bg-white flex flex-col gap-6 items-start justify-start p-6">
                    ...
                    <div className="flex flex-wrap gap-1 items-start justify-start w-full">
                      {jobData.appealPoints.business.map((point, index) => (
                        <React.Fragment key={index}>
                          ...
                          {index < jobData.appealPoints.business.length - 1 && (
                    ...
                    <div className="flex flex-wrap gap-1 items-start justify-start w-full">
                      {jobData.appealPoints.company.map((point, index) => (
                        <React.Fragment key={index}>
                          ...
                          {index < jobData.appealPoints.company.length - 1 && (
                            <span className="font-['Noto_Sans_JP'] font-medium text-[16px] leading-[2] tracking-[1.6px] text-[#323232]">、</span>
                          )}
                        </React.Fragment>
                      ))}
                  ...
                  <div className="flex flex-col gap-2 items-start justify-start w-full">
                    ...
                    <div className="flex flex-wrap gap-1 items-start justify-start w-full">
                      {jobData.appealPoints.workstyle.map((point, index) => (
                        <React.Fragment key={index}>
                          <span className="font-['Noto_Sans_JP'] font-medium text-[16px] leading-[2] tracking-[1.6px] text-[#323232]">
                            {point}
                          </span>
                          {index < jobData.appealPoints.workstyle.length - 1 && (
                            <span className="font-['Noto_Sans_JP'] font-medium text-[16px] leading-[2] tracking-[1.6px] text-[#323232]">、</span>
                          )}
                        </React.Fragment>
                      ))}
            ...
            <div className="flex flex-col gap-6 items-start justify-start">
              ...
              <div className="flex flex-col gap-2 items-start justify-start w-full">
                <div className="flex flex-row gap-2 h-7 items-center justify-start pb-1 pt-0 px-0 w-full border-b border-[#dcdcdc]">
                  <svg className="w-4 h-4 text-[#0f9058]" fill="currentColor" viewBox="0 0 15 16">
              ...
              <div className="flex flex-col gap-2 items-start justify-start w-full">
                <div className="flex flex-row gap-2 h-7 items-center justify-start pb-1 pt-0 px-0 w-full border-b border-[#dcdcdc]">
                  <svg className="w-4 h-4 text-[#0f9058]" fill="currentColor" viewBox="0 0 12 16">
              ...
              <div className="flex flex-col gap-2 items-start justify-start w-full">
                <div className="flex flex-row gap-2 h-7 items-center justify-start pb-1 pt-0 px-0 w-full border-b border-[#dcdcdc]">
                  <svg className="w-4 h-4 text-[#0f9058]" fill="currentColor" viewBox="0 0 16 13">
              ...
              <div className="flex flex-col gap-2 items-start justify-start w-full">
                <div className="flex flex-row gap-2 h-7 items-center justify-start pb-1 pt-0 px-0 w-full border-b border-[#dcdcdc]">
                  <svg className="w-4 h-4 text-[#0f9058]" fill="currentColor" viewBox="0 0 16 15">
              ...
              <div className="flex flex-col gap-2 items-start justify-start w-full">
                <div className="flex flex-row gap-2 h-7 items-center justify-start pb-1 pt-0 px-0 w-full border-b border-[#dcdcdc]">
                  <svg className="w-4 h-4 text-[#0f9058]" fill="currentColor" viewBox="0 0 13 16">
              ...
              <div className="flex flex-col gap-2 items-start justify-start w-full">
                <div className="flex flex-row gap-2 h-7 items-center justify-start pb-1 pt-0 px-0 w-full border-b border-[#dcdcdc]">
                  <svg className="w-4 h-4 text-[#0f9058]" fill="currentColor" viewBox="0 0 10 16">
              ...
              <div className="flex flex-col gap-2 items-start justify-start w-full">
                <div className="flex flex-row gap-2 h-7 items-center justify-start pb-1 pt-0 px-0 w-full border-b border-[#dcdcdc]">
                  <svg className="w-4 h-4 text-[#0f9058]" fill="currentColor" viewBox="0 0 16 16">
